...
public class Phenotainer extends Container {
   ...
   @Override
    ...
    protected <T> Class<? extends T> instance(final Class<? extends T> c) throws CannotCompileException, NotFoundException, NoSuchFieldException, IllegalArgumentException, IllegalAccessException {
