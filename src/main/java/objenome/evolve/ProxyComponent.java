 ...
 */
public abstract class ProxyComponent<T> implements PopulationProcess, Listener<ConfigEvent>, GP.GPContainerAware {

    /**
     * The <code>ConfigKey</code> of the proxied object.
     */
    protected GP.GPKey key;
    protected GP config;
     ...
     */
    public ProxyComponent(GP.GPKey key) {
        this.key = key;
    }
