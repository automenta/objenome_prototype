...
import objenome.evolve.event.ElitismEvent;

/**
 * Stat that provides the information about the start time of the elitism
 * process.
 */
public class ElitismStartTime extends AbstractStat<ElitismEvent.StartElitism> {
     ...
     */
    @Override
    public void refresh(ElitismEvent.StartElitism event) {
