...
public class OnePointCrossover extends AbstractOperator implements Listener<ConfigEvent> {
     ...
     */
    public static final GP.GPKey<Boolean> STRICT = new GP.GPKey<>();
    ...
    public void onEvent(ConfigEvent event) {
        if (event.isKindOf(PROBLEM, RandomSequence.RANDOM_SEQUENCE, PROBABILITY, STRICT)) {
    ...
    public STGPIndividual[] perform(OperatorEvent.EndOperator event, Individual... parents) {
        ...
        alignedPoints(program1.root(), program2.root(), points1, points2, 0, 0);
