...
import static objenome.evolve.population.STGP.PROBLEM;
...
public class PointMutation extends AbstractOperator implements Listener<ConfigEvent> {
     ...
     * mutated
     */
    public static final GP.GPKey<Double> POINT_PROBABILITY = new GP.GPKey<>();
    ...
    public void setConfig(GP config) {
        ...
        syntax = config.get(STGPIndividual.SYNTAX);
    ...
    public void onEvent(ConfigEvent event) {
        if (event.isKindOf(PROBLEM, RandomSequence.RANDOM_SEQUENCE, STGPIndividual.SYNTAX, POINT_PROBABILITY, PROBABILITY)) {
