 ...
 * @since 2.0
 */
public class AdjustedScoreFunction extends AbstractScorer implements Listener<ConfigEvent>, GP.GPContainerAware {

    /**
     * The key for setting the minimum fitness score possible, used when
     * calculating the adjusted fitness score.
     */
    public static final GP.GPKey<Double> MINIMUM_FITNESS_SCORE = new GP.GPKey<>();
     ...
     */
    protected static double adjustedScore(double standardised) {
        if (standardised < 0.0) {
