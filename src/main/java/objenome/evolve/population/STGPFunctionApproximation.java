...
import objenome.evolve.mutate.PointMutation;
...
import objenome.evolve.score.SumOfError;
 ...
 * @since 2.0
 */
public class STGPFunctionApproximation extends STGP {
    ...
    public STGPFunctionApproximation(int populationSize, int expressionDepth, boolean arith, boolean trig, boolean exp, boolean piecewise) {        
        ...
        criteria.add(new TerminationScore(new DoubleScore.Minimize(0.0)));
        ...
        the(SubtreeCrossover.PROBABILITY, 0.5);
        ...
        syntax.add( new DoubleERC(
                randomSequence, -1.0, 2.0, 4));
