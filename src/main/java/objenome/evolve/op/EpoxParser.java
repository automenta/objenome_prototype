...
import objenome.evolve.op.bool.Xor;
import objenome.evolve.op.lang.If;
import objenome.evolve.op.lang.Seq2;
import objenome.evolve.op.lang.Seq3;
import objenome.evolve.op.math.Absolute;
import objenome.evolve.op.math.Add;
import objenome.evolve.op.math.CoefficientPower;
import objenome.evolve.op.math.Cube;
import objenome.evolve.op.math.CubeRoot;
import objenome.evolve.op.math.DivisionProtected;
import objenome.evolve.op.math.Exponential;
import objenome.evolve.op.math.Factorial;
...
import objenome.evolve.op.math.Min3;
import objenome.evolve.op.math.ModuloProtected;
...
import objenome.evolve.op.trig.ArcCotangent;
import objenome.evolve.op.trig.ArcSecant;
import objenome.evolve.op.trig.ArcSine;
import objenome.evolve.op.trig.ArcTangent;
import objenome.evolve.op.trig.AreaHyperbolicCosine;
import objenome.evolve.op.trig.AreaHyperbolicSine;
import objenome.evolve.op.trig.AreaHyperbolicTangent;
import objenome.evolve.op.trig.Cosecant;
import objenome.evolve.op.trig.Cosine;
import objenome.evolve.op.trig.Cotangent;
import objenome.evolve.op.trig.HyperbolicCosine;
import objenome.evolve.op.trig.HyperbolicSine;
import objenome.evolve.op.trig.HyperbolicTangent;
