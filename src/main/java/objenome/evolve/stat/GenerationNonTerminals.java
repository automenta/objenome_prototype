 ...
 * @since 2.0
 */
public class GenerationNonTerminals extends AbstractStat<GenerationEvent.EndGeneration> {
    ...
    public void refresh(GenerationEvent.EndGeneration event) {
        ...
        for (Individual individual : population) {
            if (individual instanceof STGPIndividual) {
                nonTerminals[index++] = ((STGPIndividual) individual).root().countNonTerminals();
            }
        }
    }
