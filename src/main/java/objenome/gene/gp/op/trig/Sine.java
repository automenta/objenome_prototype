 ...
 */
package objenome.gene.gp.op.trig;
...
public class Sine extends Node {
     ...
     * must be a numeric type (one of Double, Float, Long, Integer). The Sine of
     * this value becomes the result of this method as a double value.
     *
