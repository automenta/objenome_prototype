...
public class Log extends Node {
     ...
     * must be of a numeric type (one of Byte, Short, Integer, Long). The base e
     * logarithm is performed on this value and the result returned as a Double.
     *
     * @return the base e logarithm performed on the the value returned from the
     * child
     */
    @Override
