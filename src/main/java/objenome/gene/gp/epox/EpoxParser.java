 ...
 */
package objenome.gene.gp.epox;

import java.util.*;

import objenome.gene.gp.epox.bool.And;
import objenome.gene.gp.epox.bool.IfAndOnlyIf;
...
import objenome.gene.gp.epox.bool.Xor;
import objenome.gene.gp.epox.lang.If;
import objenome.gene.gp.epox.lang.Seq2;
import objenome.gene.gp.epox.lang.Seq3;
import objenome.gene.gp.epox.math.Absolute;
import objenome.gene.gp.epox.math.Add;
import objenome.gene.gp.epox.math.CoefficientPower;
import objenome.gene.gp.epox.math.Cube;
import objenome.gene.gp.epox.math.CubeRoot;
import objenome.gene.gp.epox.math.DivisionProtected;
import objenome.gene.gp.epox.math.Exponential;
import objenome.gene.gp.epox.math.Factorial;
import objenome.gene.gp.epox.math.GreaterThan;
import objenome.gene.gp.epox.math.InvertProtected;
import objenome.gene.gp.epox.math.LessThan;
import objenome.gene.gp.epox.math.Log;
import objenome.gene.gp.epox.math.Log10;
import objenome.gene.gp.epox.math.Max2;
import objenome.gene.gp.epox.math.Max3;
import objenome.gene.gp.epox.math.Min2;
import objenome.gene.gp.epox.math.Min3;
import objenome.gene.gp.epox.math.ModuloProtected;
import objenome.gene.gp.epox.math.Multiply;
import objenome.gene.gp.epox.math.Power;
import objenome.gene.gp.epox.math.Signum;
import objenome.gene.gp.epox.math.Square;
import objenome.gene.gp.epox.math.SquareRoot;
import objenome.gene.gp.epox.math.Subtract;
import objenome.gene.gp.epox.trig.ArcCosecant;
import objenome.gene.gp.epox.trig.ArcCosine;
import objenome.gene.gp.epox.trig.ArcCotangent;
import objenome.gene.gp.epox.trig.ArcSecant;
import objenome.gene.gp.epox.trig.ArcSine;
import objenome.gene.gp.epox.trig.ArcTangent;
import objenome.gene.gp.epox.trig.AreaHyperbolicCosine;
import objenome.gene.gp.epox.trig.AreaHyperbolicSine;
import objenome.gene.gp.epox.trig.AreaHyperbolicTangent;
import objenome.gene.gp.epox.trig.Cosecant;
import objenome.gene.gp.epox.trig.Cosine;
import objenome.gene.gp.epox.trig.Cotangent;
import objenome.gene.gp.epox.trig.HyperbolicCosine;
import objenome.gene.gp.epox.trig.HyperbolicSine;
import objenome.gene.gp.epox.trig.HyperbolicTangent;
import objenome.gene.gp.epox.trig.Secant;
import objenome.gene.gp.epox.trig.Sine;
import objenome.gene.gp.epox.trig.Tangent;
